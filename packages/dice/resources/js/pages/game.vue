<template>
  <div class="d-flex flex-column fill-height py-3">
    <div v-if="message" class="message-container d-flex justify-center align-center">
      <game-message :message="message" class="ma-0" />
    </div>
    <div class="d-flex justify-center fill-height align-center overflow-hidden" style="background-image: url(/images/dice-bg.jpg); background-size: cover; background-position: center;">
    ...
    <div class="d-flex justify-center flex-column">
      ...
      <div class="align-self-center">
        <v-form v-model="formIsValid" class="d-md-flex px-4">
...
export default {
  ...
  components: { GameMessage, PlayControls, AnimatedNumber,Info, ModalInfo  },
