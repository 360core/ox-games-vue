<template>
  <div class="fill-height">
    ...
    <div v-else class="d-flex flex-column align-center fill-height px-4 px-sm-0 game-container justify-center">
      <div class="last-win">
        <transition-group name="staggered-fade" tag="ul" class="pa-0 d-flex flex-row-reverse" :css="false"
          @before-enter="LWbeforeEnter" @enter="LWenter" @leave="LWleave">
          <div v-for="(n, i) in winLast.slice(-10)" :key="`lw-${n}-${i}`" class="win-number">
            <span class="d-flex align-center justify-center white--text"
              :class="{ green: n === 0, red: n !== 0 && n % 2 !== 0, black: n % 2 === 0 }">{{ rouletteNums[n] }}</span>
          </div>
        </transition-group>
      </div>
      <div class="game-mode">
        <v-btn-toggle v-model="animation.mode" tile color="primary" group class="rounded-xxl">
          <v-btn value="wheel" size="x-small">
            {{ $t('Wheel') }}
          </v-btn>
      ...
      <div v-if="animation.mode == 'wheel'" class="roulette-container">
        <div class="roulette">
          <v-img src="/images/ox-icon.png" class="game-branding" />
          <object class="roulette-source">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
              ...
              <g ref="wheel" style="transform-origin:center;transform:rotate(0rad);">
                ...
                <path ref="rouletteCell0" class="st19"
                ...
                <path ref="rouletteCell1" class="st20"
                ...
                <path ref="rouletteCell22" class="st18"
                ...
                <path ref="rouletteCell23" class="st20"
                ...
                <path ref="rouletteCell27" class="st20"
                ...
                <path ref="rouletteCell28" class="st18"
                ...
                <radialGradient id="SVGID_1_" cx="345.105" cy="158.11" r="38.018"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                ...
                <radialGradient id="SVGID_2_" cx="389.2401" cy="151.1" r="34.1899"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                ...
                <radialGradient id="SVGID_3_" cx="441.3951" cy="151.2299" r="34.4024"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" style="stop-color:#333333" />
                  <stop offset="0.4464" style="stop-color:#1A1A1A" />
                  <stop offset="1" style="stop-color:#000000" />
                ...
                <radialGradient id="SVGID_4_" cx="485.135" cy="158.27" r="37.8114"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" class="whell-ic-cell-red s5" />
                  <stop offset="0.2342" class="whell-ic-cell-red s4" />
                  <stop offset="0.5295" class="whell-ic-cell-red s3" />
                ...
                <radialGradient id="SVGID_5_" cx="526.965" cy="172.61" r="41.1411"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" style="stop-color:#333333" />
                  <stop offset="0.4464" style="stop-color:#1A1A1A" />
                  <stop offset="1" style="stop-color:#000000" />
                ...
                <radialGradient id="SVGID_6_" cx="565.695" cy="194.15" r="42.8478"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" class="whell-ic-cell-red s5" />
                  <stop offset="0.2342" class="whell-ic-cell-red s4" />
                  <stop offset="0.5295" class="whell-ic-cell-red s3" />
                ...
                <radialGradient id="SVGID_7_" cx="600.1" cy="221.885" r="43.6186"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" style="stop-color:#333333" />
                  <stop offset="0.4464" style="stop-color:#1A1A1A" />
                  <stop offset="1" style="stop-color:#000000" />
                ...
                <radialGradient id="SVGID_8_" cx="629.235" cy="255.21" r="43.1912"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" class="whell-ic-cell-red s5" />
                  <stop offset="0.2342" class="whell-ic-cell-red s4" />
                  <stop offset="0.5295" class="whell-ic-cell-red s3" />
                ...
                <radialGradient id="SVGID_9_" cx="652.165" cy="293.21" r="41.6077"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" style="stop-color:#333333" />
                  <stop offset="0.4464" style="stop-color:#1A1A1A" />
                  <stop offset="1" style="stop-color:#000000" />
                ...
                <radialGradient id="SVGID_10_" cx="668.165" cy="334.455" r="38.7488"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" class="whell-ic-cell-red s5" />
                  <stop offset="0.2342" class="whell-ic-cell-red s4" />
                  <stop offset="0.5295" class="whell-ic-cell-red s3" />
                ...
                <radialGradient id="SVGID_11_" cx="676.825" cy="378.07" r="35.2201"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" style="stop-color:#333333" />
                  <stop offset="0.4464" style="stop-color:#1A1A1A" />
                  <stop offset="1" style="stop-color:#000000" />
                ...
                <radialGradient id="SVGID_12_" cx="678.435" cy="427.95" r="33.8175"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" class="whell-ic-cell-red s5" />
                  <stop offset="0.2342" class="whell-ic-cell-red s4" />
                  <stop offset="0.5295" class="whell-ic-cell-red s3" />
                ...
                <radialGradient id="SVGID_13_" cx="672.985" cy="474.22" r="37.2798"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" style="stop-color:#333333" />
                  <stop offset="0.4464" style="stop-color:#1A1A1A" />
                  <stop offset="1" style="stop-color:#000000" />
                ...
                <radialGradient id="SVGID_14_" cx="660.365" cy="516.29" r="39.9169"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" class="whell-ic-cell-red s5" />
                  <stop offset="0.2342" class="whell-ic-cell-red s4" />
                  <stop offset="0.5295" class="whell-ic-cell-red s3" />
                ...
                <radialGradient id="SVGID_15_" cx="640.745" cy="555.665" r="42.4768"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" style="stop-color:#333333" />
                  <stop offset="0.4464" style="stop-color:#1A1A1A" />
                  <stop offset="1" style="stop-color:#000000" />
                ...
                <radialGradient id="SVGID_16_" cx="614.54" cy="591.13" r="43.0913"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" class="whell-ic-cell-red s5" />
                  <stop offset="0.2342" class="whell-ic-cell-red s4" />
                  <stop offset="0.5295" class="whell-ic-cell-red s3" />
                ...
                <radialGradient id="SVGID_17_" cx="582.925" cy="621.2" r="42.9118"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" style="stop-color:#333333" />
                  <stop offset="0.4464" style="stop-color:#1A1A1A" />
                  <stop offset="1" style="stop-color:#000000" />
                ...
                <radialGradient id="SVGID_18_" cx="546.56" cy="645.575" r="41.6642"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" class="whell-ic-cell-red s5" />
                  <stop offset="0.2342" class="whell-ic-cell-red s4" />
                  <stop offset="0.5295" class="whell-ic-cell-red s3" />
                ...
                <radialGradient id="SVGID_19_" cx="506.315" cy="663.485" r="39.3389"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                ...
                <radialGradient id="SVGID_20_" cx="462.9" cy="674.27" r="36.0615"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" class="whell-ic-cell-red s5" />
                  <stop offset="0.2342" class="whell-ic-cell-red s4" />
                  <stop offset="0.5295" class="whell-ic-cell-red s3" />
                ...
                <radialGradient id="SVGID_21_" cx="415.24" cy="678.115" r="33.0715"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                ...
                <radialGradient id="SVGID_22_" cx="367.455" cy="674.43" r="35.8056"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="4.020000e-02" style="stop-color:#333333" />
                  <stop offset="0.4686" style="stop-color:#1A1A1A" />
                  <stop offset="1" style="stop-color:#000000" />
                ...
                <radialGradient id="SVGID_23_" cx="323.92" cy="663.66" r="39.3953"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" class="whell-ic-cell-red s5" />
                  <stop offset="0.2342" class="whell-ic-cell-red s4" />
                  <stop offset="0.5295" class="whell-ic-cell-red s3" />
                ...
                <radialGradient id="SVGID_24_" cx="283.4401" cy="645.725" r="41.4058"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="4.020000e-02" style="stop-color:#333333" />
                  <stop offset="0.4686" style="stop-color:#1A1A1A" />
                  <stop offset="1" style="stop-color:#000000" />
                ...
                <radialGradient id="SVGID_25_" cx="246.77" cy="621.17" r="43.0022"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" class="whell-ic-cell-red s5" />
                  <stop offset="0.2342" class="whell-ic-cell-red s4" />
                  <stop offset="0.5295" class="whell-ic-cell-red s3" />
                ...
                <radialGradient id="SVGID_26_" cx="214.975" cy="590.68" r="42.8088"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="4.020000e-02" style="stop-color:#333333" />
                  <stop offset="0.4686" style="stop-color:#1A1A1A" />
                  <stop offset="1" style="stop-color:#000000" />
                ...
                <radialGradient id="SVGID_27_" cx="189.005" cy="555.37" r="41.9973"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" class="whell-ic-cell-red s5" />
                  <stop offset="0.2342" class="whell-ic-cell-red s4" />
                  <stop offset="0.5295" class="whell-ic-cell-red s3" />
                ...
                <radialGradient id="SVGID_28_" cx="169.425" cy="516.49" r="39.6096"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="4.020000e-02" style="stop-color:#333333" />
                  <stop offset="0.4686" style="stop-color:#1A1A1A" />
                  <stop offset="1" style="stop-color:#000000" />
                ...
                <radialGradient id="SVGID_29_" cx="156.84" cy="474.285" r="36.991"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" class="whell-ic-cell-red s5" />
                  <stop offset="0.2342" class="whell-ic-cell-red s4" />
                  <stop offset="0.5295" class="whell-ic-cell-red s3" />
                ...
                <radialGradient id="SVGID_30_" cx="151.355" cy="428.5201" r="33.3083"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="4.020000e-02" style="stop-color:#333333" />
                  <stop offset="0.4686" style="stop-color:#1A1A1A" />
                  <stop offset="1" style="stop-color:#000000" />
                ...
                <radialGradient id="SVGID_31_" cx="152.955" cy="378.325" r="35.0492"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" class="whell-ic-cell-red s5" />
                  <stop offset="0.2342" class="whell-ic-cell-red s4" />
                  <stop offset="0.5295" class="whell-ic-cell-red s3" />
                ...
                <radialGradient id="SVGID_32_" cx="161.78" cy="333.925" r="38.6959"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" style="stop-color:#333333" />
                  <stop offset="0.4464" style="stop-color:#1A1A1A" />
                  <stop offset="1" style="stop-color:#000000" />
                ...
                <radialGradient id="SVGID_33_" cx="178.025" cy="292.705" r="41.2262"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" class="whell-ic-cell-red s5" />
                  <stop offset="0.2342" class="whell-ic-cell-red s4" />
                  <stop offset="0.5295" class="whell-ic-cell-red s3" />
                ...
                <radialGradient id="SVGID_34_" cx="200.68" cy="255.24" r="42.5511"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" style="stop-color:#333333" />
                  <stop offset="0.4464" style="stop-color:#1A1A1A" />
                  <stop offset="1" style="stop-color:#000000" />
                ...
                <radialGradient id="SVGID_35_" cx="229.595" cy="221.925" r="43.5852"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" class="whell-ic-cell-red s5" />
                  <stop offset="0.2342" class="whell-ic-cell-red s4" />
                  <stop offset="0.5295" class="whell-ic-cell-red s3" />
                ...
                <radialGradient id="SVGID_36_" cx="264.08" cy="194.14" r="42.5244"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" style="stop-color:#333333" />
                  <stop offset="0.4464" style="stop-color:#1A1A1A" />
                  <stop offset="1" style="stop-color:#000000" />
                ...
                <radialGradient id="SVGID_37_" cx="302.71" cy="172.625" r="41.1094"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" class="whell-ic-cell-red s5" />
                  <stop offset="0.2342" class="whell-ic-cell-red s4" />
                  <stop offset="0.5295" class="whell-ic-cell-red s3" />
                ...
                <radialGradient id="SVGID_38_" cx="414.64" cy="414.27" r="225.5"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
                ...
                <radialGradient id="SVGID_39_" cx="414.5" cy="414.54" r="411.5"
                  gradientTransform="matrix(1 0 0 -1 0 829.04)" gradientUnits="userSpaceOnUse">
          ...
          <object class="outside">
            <!-- <img src="/images/raulette-wheel-background.png" ref="wheel2" class="outside-wheel-bg" style="width: 100%;"> -->
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
              viewBox="0 0 456 456">
        ...
        <div class="line">
          <div ref="line" class="line-body">
            <template v-for="x in 4">
              <div v-for="(n, i) in rouletteNums" :key="`ln-rect-${x}-${i}`"
      ...
      <div class="game-bet-group d-flex justify-center align-center py-6 flex-wrap">
        <v-text-field v-model.number="bet" dense outlined :full-width="false" class="bet-input text-center mr-4"
          :label="$t('Bet')"
          :rules="[validationInteger, v => validationMin(v, minBet), v => validationMax(v, Math.min(Math.floor(account.balance), maxBet))]"
          prepend-inner-icon="mdi-minus" append-icon="mdi-plus" hide-details @click:prepend-inner="decreaseBet"
        ...
        <div class="mt-4 mt-sm-0 d-flex flex-wrap">
          <v-badge class="bet-badge ma-1" :color="$vuetify.theme.dark ? 'white' : 'red'" overlap
            :value="mybet['red'] !== undefined && mybet['red'] > 0" :content="mybet['red']">
            <v-btn :disabled="!canMakeBet" :color="winColor == 'red' ? 'primary' : 'red'" :outlined="winColor !== 'red'"
              @click="makeBet('red')">
              {{ $t('Bet red') }}
            </v-btn>
          </v-badge>
          <v-badge class="bet-badge ma-1" :color="$vuetify.theme.dark ? 'white' : 'green'" overlap
            :value="mybet['zero'] !== undefined && mybet['zero'] > 0" :content="mybet['zero']">
            <v-btn :disabled="!canMakeBet" :color="winColor == 'zero' ? 'primary' : 'green'"
              :outlined="winColor !== 'zero'" @click="makeBet('zero')">
              {{ $t('Bet zero') }}
            </v-btn>
          </v-badge>
          <v-badge class="bet-badge ma-1" :color="$vuetify.theme.dark ? 'white' : 'grey'" overlap
            :value="mybet['black'] !== undefined && mybet['black'] > 0" :content="mybet['black']">
            <v-btn :disabled="!canMakeBet" :color="winColor == 'black' ? 'primary' : 'grey'"
              :outlined="winColor !== 'black'" @click="makeBet('black')">
              {{ $t('Bet Black') }}
            </v-btn>
          </v-badge>
        </div>
      ...
      <div class="d-flex bet-list mt-6 flex-column flex-sm-row bet-panels">
        <v-card class="bet-red mr-sm-3 flex-grow-1 mb-4 mb-sm-0 game-frame-2 pa-0 rounded-xxl" outlined
          :class="{ transparent: winColor && winColor != 'red', win: winColor == 'red' }">
          <v-card-title class="pb-1">
            <span class="red--text text-uppercase">{{ $t('Red') }}</span> <v-spacer /> <span
              class="text-uppercase mr-1">{{
                $t('Win') }}</span>x{{ config.paytable.red }}
          </v-card-title>
          <v-card-text>
            ...
            <transition-group name="staggered-fade" tag="ul" class="pa-0" :css="false" @before-enter="beforeEnter"
              ...
              <li v-for="(item, index) in betsRed" :key="`red-${item.id}`" :data-index="index"
                class="d-flex align-center pb-2 overflow-hidden">
        ...
        <v-card class="bet-zero mr-sm-3 flex-grow-1 mb-4 mb-sm-0 game-frame-2 pa-0 rounded-xxl" outlined
          :class="{ transparent: winColor && winColor != 'zero', win: winColor == 'zero' }">
          <v-card-title class="pb-1">
            <span class="green--text text-uppercase">{{ $t('Zero') }}</span> <v-spacer /> <span
              class="text-uppercase mr-1">{{
                $t('Win') }}</span>x{{ config.paytable.zero }}
          </v-card-title>
          <v-card-text>
            <div class="justify-center d-flex mb-2">
              <div class="mr-1">
            ...
            <transition-group name="staggered-fade" tag="ul" class="pa-0" :css="false" @before-enter="beforeEnter"
              @enter="enter" @leave="leave">
              <li v-for="(item, index) in betsZero" :key="`zero-${item.id}`" :data-index="index"
                class="d-flex pb-2 align-center overflow-hidden">
                <div class="d-flex align-center flex-grow-1">
                  <user-avatar :user="item" :size="24" class="mr-2" />
                  <user-profile-modal :user="item" />
                  <v-spacer />
        ...
        <v-card class="bet-black flex-grow-1 mb-4 mb-sm-0 game-frame-2 pa-0 rounded-xxl" outlined
          :class="{ transparent: winColor && winColor != 'black', win: winColor == 'black' }">
          <v-card-title class="pb-1">
            <span class="grey--text text-uppercase">{{ $t('Black') }}</span> <v-spacer /> <span
              class="text-uppercase mr-1">{{
                $t('Win') }}</span>x{{ config.paytable.black }}
          </v-card-title>
          <v-card-text>
            <div class="justify-center d-flex mb-2">
              <div class="mr-1">
            ...
            <transition-group name="staggered-fade" tag="ul" class="pa-0" :css="false" @before-enter="beforeEnter"
              @enter="enter" @leave="leave">
              <li v-for="(item, index) in betsBlack" :key="`black-${item.id}`" :data-index="index"
                class="d-flex pb-2 align-center overflow-hidden">
                <div class="d-flex align-center flex-grow-1">
                  <user-avatar :user="item" :size="24" class="mr-2" />
                  <user-profile-modal :user="item" />
...
export default {
  ...
  components: { MultiplayerGameEvent, AnimatedNumber, BlockPreloader, UserProfileModal, UserAvatar, Info, ModalInfo },
  ...
  watch: {
    'animation.mode': function (currentValue, previousValue) {
