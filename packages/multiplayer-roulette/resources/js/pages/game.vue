    ...
    <div v-else class="d-flex flex-column align-center fill-height px-4 px-sm-0 game-container justify-center">
      ...
      <div class="game-bet-group d-flex justify-center align-center py-6 flex-wrap">
        ...
        <div class="mt-4 mt-sm-0 d-flex flex-wrap">
          <v-badge class="bet-badge ma-1" :color="$vuetify.theme.dark ? 'white' : 'red'" overlap :value="mybet['red'] !== undefined && mybet['red'] > 0" :content="mybet['red']">
            <v-btn :disabled="!canMakeBet" :color="winColor == 'red' ? 'primary' : 'red'" :outlined="winColor !== 'red'" @click="makeBet('red')">
              {{ $t('Bet red') }}
            </v-btn>
          </v-badge>
          <v-badge class="bet-badge ma-1" :color="$vuetify.theme.dark ? 'white' : 'green'" overlap :value="mybet['zero'] !== undefined && mybet['zero'] > 0" :content="mybet['zero']">
            <v-btn :disabled="!canMakeBet" :color="winColor == 'zero' ? 'primary' : 'green'" :outlined="winColor !== 'zero'" @click="makeBet('zero')">
              {{ $t('Bet zero') }}
            </v-btn>
          </v-badge>
          <v-badge class="bet-badge ma-1" :color="$vuetify.theme.dark ? 'white' : 'grey'" overlap :value="mybet['black'] !== undefined && mybet['black'] > 0" :content="mybet['black']">
      ...
      <div class="d-flex bet-list mt-6 flex-column flex-sm-row bet-panels">
        <v-card class="bet-red mr-sm-3 flex-grow-1 mb-4 mb-sm-0 game-frame-2 pa-0 rounded-xxl" outlined :class="{transparent: winColor && winColor != 'red', win: winColor == 'red'}">
        ...
        <v-card class="bet-zero mr-sm-3 flex-grow-1 mb-4 mb-sm-0 game-frame-2 pa-0 rounded-xxl" outlined :class="{transparent: winColor && winColor != 'zero', win: winColor == 'zero'}">
          <v-card-title class="pb-1">
        ...
        <v-card class="bet-black flex-grow-1 mb-4 mb-sm-0 game-frame-2 pa-0 rounded-xxl" outlined :class="{transparent: winColor && winColor != 'black', win: winColor == 'black'}">
          <v-card-title class="pb-1">
...
<style lang="scss" scoped>
  ...
  .roulette {
    ...
    .outside {
      ...
      display:block;
      position:relative;
      .gradient.g1 {stop-color:#212330;stop-opacity: 0.00;}
      .gradient.g2 {stop-color:#212330;stop-opacity: 0.00;}
      .gradient.g3 {stop-color:#212330;stop-opacity: 0.10;}
      .gradient.g4 {stop-color:#212330;stop-opacity: 0.25;}
      .gradient.g5 {stop-color:#212330;}
      .st0{stroke:#212330;}
    }
    .arrow-body {
      position: absolute;
