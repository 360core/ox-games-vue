          ...
          <div class="game-status text-center">
            ...
            <template v-else-if="playing">
              ...
              <div class="game-payout">
                ...
                <span class="text-h3">{{ currentPayout.toFixed(2) }}</span>
              </div>
            </template>
            <template v-else-if="!betting && !playing">
              ...
              <div v-if="crashedAt.length === 0" class="">
                {{ $t('Waiting next game') }}
              </div>
            </template>
          </div>
...
import crashSound from 'packages/crash/resources/audio/bang.wav'
...
import rocketSprite from 'packages/crash/resources/animations/new-rocket.svg'
import rocketStaySprite from 'packages/crash/resources/animations/rocket-stay.svg'
import airplaneSprite from 'packages/crash/resources/animations/planet-3.png'
