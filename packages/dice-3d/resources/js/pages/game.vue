<template>
  <div class="d-flex flex-column fill-height py-3">
    ...
    <div class="d-flex justify-center fill-height align-center position-relative dice-3d-container">
      <img src="/images/dice-bg.svg" class="dice-3d-bg-table" />
      <!-- <img src="/images/dice-bg.svg" class="dice-3d-mobile-bg-table" /> -->
