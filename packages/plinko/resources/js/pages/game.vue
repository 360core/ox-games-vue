<template>
  <div class="d-flex flex-column fill-height pb-0 pt-4 align-center justify-center">
    <div class="message-container" :class="{loading: !ready}">
      <game-message class="message" :message="message" />
    </div>
    <div ref="game" class="game d-flex justify-center flex-col align-center mb-5" :class="{light: !$vuetify.theme.dark, loading: !ready}">
      <img src="/images/ox-icon.png" class="plinko-logo" alt="">
    </div>
